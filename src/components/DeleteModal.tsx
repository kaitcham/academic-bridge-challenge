...
import { deleteTodo } from "../utils/requests";

export const DeleteModal = () => {
  const { todo, allTodos, setAllTodos } = useTodosContext();
  const { isDeleteModelOpen, setIsDeleteModelOpen } = useGlobalContext();
  ...
  return (
    <>
      <Transition appear show={isDeleteModelOpen} as={Fragment}>
